  ...
  module.controller('pcap', function($scope, $http) {
    ...
    $scope.get_data = function() {
      ...
      responsePromise.success(function(data, status, headers, config) {
        ...
        packet1info.push(data.pdml.packet[0].proto[0].field[0].$.value);
        ...
        packet2info.push(data.pdml.packet[1].proto[0].field[0].$.value);
        ...
        packet3info.push(data.pdml.packet[2].proto[0].field[0].$.value);
